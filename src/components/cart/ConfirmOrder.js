      ...
      <div className="row d-flex justify-content-between">
              ...
              <div className="cart-item my-1">
                <div className="row">
                  ...
                  <div className="col-4 col-lg-4 mt-4 mt-lg-0">
                    <p>
                      {item.cantidad} x Q{item.precio} = <b>Q{item.totalLine}</b>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="col-12 col-lg-3 my-4">
          <div id="order_summary">
            ...
            <hr />
            <p>
              Subtotal: <span className="order-summary-values">Q{subtotal}</span>
            </p>
            <p>
              Precio de Envio: <span className="order-summary-values">Q{precioEnvio}</span>
            </p>
            <p>
              Impuesto: <span className="order-summary-values">Q{impuesto}</span>
            </p>

            <hr />

            <p>
              Total: <span className="order-summary-values">Q{total}</span>
            </p>
